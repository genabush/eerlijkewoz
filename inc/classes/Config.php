...
class Config
{
    ...
    public function registerNavMenus()
    {
        ...
        $menus = [
            'primary' => esc_html__( 'Primary', 'eerlijke' ),
            'footer' => esc_html__( 'Footer', 'eerlijke' )
        ];
    ...
    public function registerSidebars()
    {
         ...
         register_sidebar( [
             'name'          => sprintf( __( 'Footer 1', 'eerlijke' ) ),
             'id'            => "footer1",
             'description'   => '',
             'class'         => '',
        ...
        register_sidebar( [
            'name'          => sprintf( __( 'Footer 2', 'eerlijke' ) ),
            'id'            => "footer2",
            'description'   => '',
            'class'         => '',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
        ...
        register_sidebar( [
            'name'          => sprintf( __( 'Footer 3', 'eerlijke' ) ),
            'id'            => "footer3",
            'description'   => '',
            'class'         => '',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
        ...
        register_sidebar( [
            'name'          => sprintf( __( 'Footer 4', 'eerlijke' ) ),
            'id'            => "footer4",
            'description'   => '',
            'class'         => '',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
